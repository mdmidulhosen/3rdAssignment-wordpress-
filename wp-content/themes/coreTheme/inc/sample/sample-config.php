...
// START Logo Change Field

redux::set_section(
$opt_name,
	array(
		'title'            => esc_html__( 'Logo', 'coreTheme' ),
		'id'               => 'logo',
		'desc'             => esc_html__( 'Change your logo from here', 'coreTheme' ),
		...
		'fields'=> array(
			array(
				'id' => 'header-logo',
				'type'=>'media',
				'title'            => esc_html__( 'Header Logo', 'coreTheme' ),
				'desc'             => esc_html__( 'Change your logo from here', 'coreTheme' ),
			),
			...
			array(
				'id' => 'footer-logo',
				'type'=>'media',
				'title'            => esc_html__( 'Footer Logo', 'coreTheme' ),
				'desc'             => esc_html__( 'Change your logo from here', 'coreTheme' ),
			),
		)
	)
...
$opt_name,
	array(
		'title'            => esc_html__( 'Title', 'coreTheme' ),
		'id'               => 'title',
		'desc'             => esc_html__( 'header title', 'coreTheme' ),
		'customizer_width' => '400px',
		...
		'fields'=> array(
			array(
				'id' => 'header-title',
				'type'=>'text',
				'title'            => esc_html__( 'Header Title', 'coreTheme' ),
				'desc'             => esc_html__( 'Change your header title from here', 'coreTheme' ),
			),

			array(
				'id' => 'footer-title',
				'type'=>'text',
				'title'            => esc_html__( 'Footer Title', 'coreTheme' ),
				'desc'             => esc_html__( 'Change your footer title from here', 'coreTheme' ),
			),
		)
	)
);
...
$opt_name,
	array(
		'title'            => esc_html__( 'Social Media', 'coreTheme' ),
		'id'               => 'social-media',
		'desc'             => esc_html__( 'Add your social media link here', 'coreTheme' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-facebook',
		'fields'=> array(
			array(
				'id' 				=> 'facebook',
				'type'				=>'text',
				'title'            	=> esc_html__( 'Facebook', 'coreTheme' ),
			),

			array(
				'id' => 'twitter',
				'type'=>'text',
				'title'            	=> esc_html__( 'Twitter', 'coreTheme' ),
			),
			array(
				'id' => 'linkedin',
				'type'=>'text',
				'title'            	=> esc_html__( 'LinkedIn', 'coreTheme' ),
			),
			array(
				'id' => 'instagram',
				'type'=>'text',
				'title'            	=> esc_html__( 'Instagram', 'coreTheme' ),
			),
		)
	)
);
...
$opt_name,
	array(
		'title'            => esc_html__( 'Copyright', 'coreTheme' ),
		'id'               => 'copyright',
		'customizer_width' => '400px',
		...
		'fields'=> array(
			array(
				'id' => 'copyright',
				'type'=>'text',
				'title'            => esc_html__( 'Footer Copyright', 'coreTheme' ),
				'desc'             => esc_html__( 'Change your footer copyright from here', 'coreTheme' ),
			),
		)
	)
);
